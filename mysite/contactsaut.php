...
<nav class="headMenu">
 ...
 echo ' <div class="mainmenu"><a href="news.php">ПРОДУКЦИЯ</a></div>';
else
echo ' <div class="mainmenu"><a href="newsusers.php">ПРОДУКЦИЯ</a></div>';
 ?>
 <div class="mainmenu"><a  class="activ"  href="#">КОНТАКТЫ</a></div>
</nav>
...
else echo "Неправильно введен логин или пароль. Повторите попытку.";
}
